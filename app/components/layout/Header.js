    ...
    <header className=" fixed inset-x-0 p-b top-0 z-[100] pt-[40px] pb-[20px] px-[20px] sm:px-[90px]">
      <div ref={rootRef} className="flex  justify-between items-start">
        ...
        {/* <button
          ...
          onClick={() => setOpen((v) => !v)}
          className="flex justify-start w-8 border-t pt-4 border-solid border-indigo-black focus:outline-none"
        >
          <div
            className={clsx(
        ...
        {/* <nav
          ...
          aria-hidden={!open}
          className={clsx(
            "flex flex-col text-base gap-[10px] transition duration-200 origin-top",
            ...
            <div className="text-sm flex items-center justify-end gap-1">
              <span> Location: </span>
                ...
                {weather.loading ? (
                  ...
                  <>
                   <div className="relative left-1 text-sm max-w-[23px]">{weather.temp}°</div>
